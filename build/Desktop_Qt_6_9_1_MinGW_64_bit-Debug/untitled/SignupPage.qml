        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Column {
                    ...
                    // Email field
                    TextField {
                        id: userEmail; placeholderText: "Email"; width: 260; height: 40; font.pixelSize: 16; color: "white";
                        placeholderTextColor: "#a0a0a0"; anchors.horizontalCenter: parent.horizontalCenter; background: Rectangle { color: "#404040"; radius: 8 }
                    }
                    ...
                    Rectangle {
                        ...
                        MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: { /* Registration logic will be added here */ } }
